#!/bin/bash
# =============================================================================
# DTU HPC (LSF) — hbn_ccd_rt_4s downstream preprocessing, 5-shard array
# =============================================================================
...
#
# Submit: bsub < jobs/spectrum/hbn_ccd_rt_4s.sh
# Monitor: bjobs -u $USER ; bpeek <JOBID>
# =============================================================================

#BSUB -q hpc
#BSUB -J "hbn_ccd_rt_4s[1-5]"
#BSUB -oo /zhome/33/6/147533/SPEED/logs/spectrum/hbn_ccd_rt_4s_%J.%I.out
#BSUB -eo /zhome/33/6/147533/SPEED/logs/spectrum/hbn_ccd_rt_4s_%J.%I.err
#BSUB -W 24:00
#BSUB -n 16
#BSUB -R "span[hosts=1]"
...
CONFIG="configs/downstream/hbn_ccd_rt_4s.yaml"
NAME="hbn_ccd_rt_4s"
N_SHARDS=5
