#!/bin/bash
# =============================================================================
# DTU HPC (LSF) — hbn_ccd_correct downstream preprocessing, 5-shard array
# =============================================================================
...
#
# Submit: bsub < jobs/spectrum/hbn_ccd_correct.sh
# Monitor: bjobs -u $USER ; bpeek <JOBID>
# =============================================================================

#BSUB -q hpc
#BSUB -J "hbn_ccd_correct[1-5]"
#BSUB -oo /work3/agjma/SPEED/logs/spectrum/hbn_ccd_correct_%J.%I.out
#BSUB -eo /work3/agjma/SPEED/logs/spectrum/hbn_ccd_correct_%J.%I.err
#BSUB -W 24:00
#BSUB -n 16
#BSUB -R "span[hosts=1]"
...
CONFIG="configs/downstream/hbn_ccd_correct.yaml"
NAME="hbn_ccd_correct"
N_SHARDS=5
